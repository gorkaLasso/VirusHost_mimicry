...
#my $seqFilterTag = "";
#my $backgroundFile = "/home/gl2411/ifs/data/c2b2/bh_lab/gl2411/Databases/Skan_summary/6_taxonomy_group_prevalence.txt";

#sequence filtering in Skan at 90%
#my $seqFilterTag = "_filtAT90";
#my $backgroundFile = "/home/gl2411/ifs/data/c2b2/bh_lab/gl2411/Databases/Skan_summary/filtered_at_90/6_taxonomy_group_prevalence.txt";

#sequence filtering in Skan at 70%
#my $seqFilterTag = "_filtAT70";
#my $backgroundFile = "/home/gl2411/ifs/data/c2b2/bh_lab/gl2411/Databases/Skan_summary/filtered_at_70/6_taxonomy_group_prevalence.txt";

#sequence filtering in Skan at 40%
my $seqFilterTag = "_filtAT40";
my $backgroundFile = "/home/gl2411/ifs/data/c2b2/bh_lab/gl2411/Databases/Skan_summary/filtered_at_40/6_taxonomy_group_prevalence.txt";
...
sub Main{
  ...
  my $outFile = $inputDir . "/enrichment_" . $sasThresh . $seqFilterTag . ".txt";
